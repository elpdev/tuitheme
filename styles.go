...
func newTheme(p palette) Theme {
	return Theme{
		...
		Title:         lipgloss.NewStyle().Bold(true).Foreground(p.accentAlt).Background(p.bg),
		...
		HeaderAccent:  lipgloss.NewStyle().Foreground(p.accentAlt).Background(p.bg).Bold(true),
